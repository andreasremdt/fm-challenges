...
function Header({ isMenuOpen, onMenuToggle }: Props) {
  return (
    <Wrapper>
      <MenuToggle type="button" aria-label={isMenuOpen ? "Close navigation" : "Open navigation"} onClick={onMenuToggle}>
        {isMenuOpen ? (
      ...
      <Logo>
        <svg aria-hidden="true" width="130" height="12" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <File editable meta="Document Name" name="welcome.md" />

      <TrashButton type="button" aria-label="Delete document">
